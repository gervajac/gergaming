...
import gerva from "../../assets/gerva6.png";
        ...
        <div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
          <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-black">
                Gertech es un e-commerce ficticio de venta de HardWare y
              ...
              <div className="md:mt-14 mt-12 flex flex-col items-center">
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  Soy Gervasio Jacob, soy desarrollador web Full Stack y tengo
                  25 años.
                </p>
              </div>
              <div className="mt-7 flex flex-col items-center">
                <div
                  className="w-20 h-20 bg-white text-black shadow rounded-full flex items-center justify-center"
                  role="img"
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  El proyecto lo realicé debido a mi pasión por el hardWare, en
                  mi pasado me dediqué a mi emprendimiento de venta de insumos
                  de HardWare y reparación técnica.
                </p>
              </div>
              ...
              <div className="mt-7 flex flex-col items-center">
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  Para este proyecto use: Typescript, React, Vite, Tailwind,
                  Stripe; NodeJS, Express y MongoDB
                </p>
              </div>
              <div className="mt-7 flex flex-col items-center">
                <div
