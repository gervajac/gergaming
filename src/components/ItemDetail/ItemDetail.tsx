...
console.log(state.details, "ESTADO")
			...
			<div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
			  ...
			  <div className="flex mb-4">
				<span className="flex items-center">
				  <span className="text-gray-600">{item.category === "ram" ? "MEMORIA RAM" : item.category}</span>
				</span>
			  </div>
			  <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
			  </div>
			  <span className="flex justify-stretch"><img src={garantia}></img>- Garantia</span>
			  <span className="flex justify-stretch"><img src={check}></img>- Envios a todo el pais</span>
			  <span className="flex justify-stretch"><img src={stock}></img>- Stock disponible</span>
			  <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
			  </div>
			  <div className="flex">
				<span className="title-font font-medium text-2xl text-gray-900">${item.price} ARS</span>
