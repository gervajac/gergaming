...
const Footer : React.FC<FooterProps> = () => {
	return (
<footer className="bg-gray-900 text-white flex flex-row justify-center">
  <div className="container px-6 pt-6">
    <div className="mb-6 flex justify-center">
      <Link to="mailto:gerva.jacob.tropini@gmail.com"
        type="button"
      ...
      <Link
        to="https://www.instagram.com/gervajac/"
        type="button"
        className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
        data-te-ripple-init
        data-te-ripple-color="light">
      ...
      <Link
        to="https://www.linkedin.com/in/gervasio-jacob/"
        type="button"
        className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
        data-te-ripple-init
        data-te-ripple-color="light">
      ...
      <form action="">
        <div
          ...
          <div className="md:mb-6 md:ml-auto">
            <p className="">
              <strong>Suscribirse al Newsletter</strong>
            </p>
          </div>
    ...
    <div className="grid mb-2 items-center justify-center">
      <p>
